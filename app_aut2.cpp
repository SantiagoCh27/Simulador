...
#define ID_EDIT_TIEMPO 5  // Añadido el ID para el campo de tiempo

// Variables globales
HWND hwndButtonStart, hwndEditDelay1, hwndEditDelay2, hwndEditDelay3;
HWND hwndRadioNormal, hwndRadioCronometro;
HWND hwndTiempo;  // Añadida la declaración global para el campo de tiempo
...
void AutomatizarClics() {
    ...
    // Actualizar el tiempo usando SendMessage en lugar de PostMessage
    wchar_t tiempo[50];
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    // Campo para mostrar el tiempo de ejecución (movido más abajo)
    CreateWindowEx(
